...
export default function ManagementScreen({ navigation }: any) {
  ...
  const menuItems = [
    { icon: require('../assets/QuanLy/report.png'), title: 'Báo cáo tổng hợp', subtitle: 'Tổng hợp số liệu thống kê' },
    { icon: require('../assets/QuanLy/shift.png'), title: 'Quản lý bảng công', subtitle: 'Theo dõi công theo nhân viên' },
    { icon: require('../assets/QuanLy/day-off.png'), title: 'Duyệt đơn nghỉ', subtitle: 'Xử lý đơn xin nghỉ' },
    { icon: require('../assets/QuanLy/overtime.png'), title: 'Duyệt đơn xin OT', subtitle: 'Xử lý đơn xin OT' },
    { icon: require('../assets/QuanLy/working.png'), title: 'Duyệt tăng ca nhân viên', subtitle: 'Xác nhận đơn xin tăng ca' },

    // ⭐⭐ Cái này cần điều hướng sang EmployeeManagement
    { icon: require('../assets/QuanLy/personal-information.png'), title: 'Quản lý nhân viên', subtitle: 'Danh sách nhân viên', route: 'EmployeeManagement' },
  ...
  route: 'DepartmentManagement',   // ⭐ THÊM ROUTE
    ...
    { icon: require('../assets/QuanLy/team.png'), title: 'Chính sách ca làm việc và ngày nghỉ', subtitle: 'Thiết lập ca làm, ngày nghỉ' },
   {
...
const styles = StyleSheet.create({
  ...
  searchContainer: { paddingHorizontal: 16, paddingTop: 25, paddingBottom: 10, zIndex: 10 },
  searchWrapper: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF',
    borderRadius: 25, paddingLeft: 16, paddingRight: 8, shadowColor: '#000',
    shadowOpacity: 0.1, shadowRadius: 8, elevation: 3
  },
  searchInput: { flex: 1, height: 50, fontSize: 15, color: '#333' },
  searchButton: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: '#EBF5FD',
  ...
  menuTitle: { fontSize: 17, fontWeight: '700', color: '#1A1A1A', marginBottom: 6 },
