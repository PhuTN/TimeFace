  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        <View style={{ height: theme.spacing(2) }} />
        <Button title="Job Information" onPress={() => navigation.navigate('JobInformation')} />
        <View style={{ height: theme.spacing(2) }} />
        <Button title="Personal Information" onPress={() => navigation.navigate('PersonalInformation')} />
        <View style={{ height: theme.spacing(2) }} />
