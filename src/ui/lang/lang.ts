...
export const Lang = {
  ...
  face_step_front: ["Đưa mặt thẳng vào khung", "Put your face straight into the frame"],
  ...
  face_status_label: ["Hãy giữ yên trong khi chúng tôi chụp ảnh khuôn mặt bạn...", "Hold still while we capture your face..."],
  face_retry_link: ["Thử lại", "Try again"],
  face_camera_not_ready: ["Camera chưa sẵn sàng. Hãy kiểm tra quyền.", "Camera is not ready yet. Check permissions."],
  face_face_not_centered: ["Giữ khuôn mặt của bạn bên trong hình oval hơn một chút.", "Keep your face inside the oval a bit longer."],
  face_smile_not_detected: ["Hãy cho chúng tôi một nụ cười tươi hơn.", "Give us a clearer smile."],
  face_blink_not_detected: ["Nháy mắt thêm lần nữa để chúng tôi có thể phát hiện ra.", "Blink once more so we can detect it."],
  face_face_not_front: ["Vui lòng đưa khuôn mặt thẳng của bạn vào khung hình.", "Please put your face straight into the frame."],
  face_face_not_left: ["Vui lòng đưa khuôn mặt bên trái của bạn vào khung hình.", "Please put your left side face in the frame."],
  face_face_not_right: ["Vui lòng đưa khuôn mặt bên phải của bạn vào khung hình.", "Please put your right side face in the frame."],
  face_capture_failed: ["Không thể chụp ảnh. Vui lòng thử lại.", "Could not capture a snapshot. Please try again."],
  ...
  job_number_of_days_off: ["Số ngày phép trong năm", "Number of days off per year"],
  ...
  profile_upload_hint: ["Định dạng phải ở dạng .jpeg .png có kích thước ít nhất là 800x800px và nhỏ hơn 5MB", "Format should be in .jpeg .png at least 800x800px and less than 5MB"],
  ...
  profile_address_hint: ["Nơi cư trú hiện tại của bạn", "Your current domicile"],
  ...
  profile_select_avatar_text: ["Bạn muốn lấy ảnh từ đâu?", "Where do you want to get the photo from?"],
