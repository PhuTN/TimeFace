...
type ICRequestFilterModalProps = {
  visible: boolean;
  onClose: () => void;
  onApplyFilters?: (filters: ICRequestFilters) => void;
};

export type ICRequestFilters = {
  employeeName: string;
...
export default function ICRequestFilterModal({
  visible,
  onClose,
  onApplyFilters,
}: ICRequestFilterModalProps) {
  ...
  const handleApplyFilters = () => {
    const filters: ICRequestFilters = {
      employeeName,
      approvalStatus,
      positionName,
      changeDate,
    ...
    console.log('Applied IC Request filters:', filters);
      ...
      <View
        ...
        <ScrollView
          ...
          <View style={S.card}>
            ...
            {/* Row 2: Trạng thái duyệt, Tên chức vụ */}
            <Row>
              <LabeledSelect
